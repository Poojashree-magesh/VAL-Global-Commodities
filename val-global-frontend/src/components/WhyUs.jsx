...
const reasons = [
  { icon: '🌍', num: '01', title: 'Worldwide Sourcing Network', desc: 'Multi-state sourcing flexibility with seasonal crop planning. Strong procurement network across the globe with year-round availability.' },
  { icon: '🚢', num: '02', title: 'Export Capacity & Markets', desc: '4–5 Metric Tons per category per month. Scalable container shipments, long-term supply contracts, global ports clearance.' },
  { icon: '🌱', num: '03', title: 'Direct Farmer Sourcing', desc: 'No middlemen — direct from certified farms. Full traceability from field to export port, with on-time container shipments.' },
  { icon: '🏅', num: '04', title: 'Farm-to-Export Model', desc: 'Structured farm-to-export with certification-ready processes and scalable supply capacity ensuring uncompromised quality.' },
  { icon: '🤝', num: '05', title: 'Transparent & Reliable', desc: 'We deliver reliability, not just products. Honest pricing, scalable contract-based supply execution, long-term partnerships.' },
  { icon: '💚', num: '06', title: 'Ethical & Clean Products', desc: '100% chemical-free products. We support women-led SHGs and traditional farming communities at every step.' },
]
const stats = [{ value: '4–5 MT', label: 'Per Category/Month' }, { value: '3+', label: 'Global Markets' }, { value: '8', label: 'Product Categories' }, { value: '100%', label: 'Chemical-Free' }]
  ...
  return (
    <>
      <style>{`
        ...
        .why-stat { padding:2.2rem 1.5rem; text-align:center; border-right:1px solid rgba(255,255,255,0.08); transition:background 0.25s; }
        ...
        .why-card { background:var(--green-dark); padding:2.4rem 2rem; transition:background 0.3s,transform 0.3s; }
        ...
        .why-card:hover .why-icon-wrap { transform:scale(1.18); }
      ...
      <section className="why-section" id="why">
        ...
        <div className="why-bg-text" aria-hidden="true">VAL</div>

        <div className="why-inner">
          <div className="why-top">
            <SectionReveal className="reveal-left">
              <div className="eyebrow">Why Choose Us</div>
              <h2 className="stitle" style={{ maxWidth: 520 }}>Worldwide Sourcing &amp; Delivery Network</h2>
            </SectionReveal>
            <SectionReveal className="reveal-right" delay="0.1s">
              <p className="sdesc" style={{ maxWidth: 380 }}>VAL Global Commodities maintains a strong procurement network across the globe. We don't just supply products — we deliver reliability.</p>
            </SectionReveal>
          </div>
          ...
          <SectionReveal className="reveal" delay="0.15s">
            <div className="why-bullets">
              {['Multi-State Sourcing Flexibility', 'Seasonal Crop Planning', 'Year-Round Availability', 'Efficient Port Coordination', 'On-Time Container Shipments', 'Scalable Contract Supply'].map((b, i) => (
