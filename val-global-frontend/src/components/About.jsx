...
const tabs = [
  {
    id: "who",
    label: "Who We Are",
    content: `At VAL Global Commodities, we believe great products begin at the source. We connect global markets directly with honest, high-quality Indian products — without unnecessary intermediaries. Our journey began with a vision to create a sourcing system where quality is consistent, pricing is fair, and every product is traceable from farm to shipment.`,
    points: [
      "India-based export company with direct farmer networks",
      "Strong connections with cooperatives, spice growers & millet cultivators",
      "Women-led SHG groups for honey and lifestyle product processing",
    ],
  },
  {
    id: "approach",
    label: "Our Approach",
    content: `We follow a transparent sourcing model ensuring product integrity, ethical cultivation, and export-grade quality from farm to shipment. Our approach eliminates unnecessary intermediaries, ensuring you get the best quality at fair prices with full traceability at every step.`,
    points: [
      "Direct sourcing from verified farms and cooperatives",
      "Rigorous quality checks at source and before export",
      "Transparent documentation and fair pricing",
    ],
  },
  {
    id: "commit",
    label: "Our Commitment",
    content: `We are committed to reliability, clear communication, and delivering exactly what we promise — every time. We build long-term partnerships based on trust, consistency, and transparency with both our farming communities and global buyers.`,
    points: [
      "100% chemical-free, clean-label products",
      "Long-term buyer-farmer relationship building",
...
const stats = [
  ...
  { n: "3+", l: "Export Markets" },
  { n: "0", l: "Intermediaries" },
  { n: "100%", l: "Chemical-Free" },
];
  ...
  return (
    <>
      <style>{`
        ...
        .tab-bar { display:flex; gap:0; border-bottom:1px solid #e0dbd4; margin-bottom:2rem; overflow-x:auto; -webkit-overflow-scrolling:touch; scrollbar-width:none; }
        ...
        @media(max-width:768px){
          ...
          .tab-btn { padding:11px 16px; font-size:0.78rem; letter-spacing:0.03em; }
          .tab-text { font-size:0.98rem; line-height:1.8; }
          .about-stats { margin-top:1.8rem; }
        }
        @media(max-width:600px){
          .about-section { padding:70px 5%; }
          .about-img { height:360px; }
          .about-badge { top:14px; left:10px; padding:14px 16px; }
          .about-badge-n { font-size:1.9rem; }
          .about-badge-l { font-size:0.66rem; }
          .about-corner { width:100px; height:100px; right:-8px; bottom:-8px; }
          .tab-btn { padding:10px 14px; font-size:0.74rem; }
          .tab-text { font-size:0.95rem; line-height:1.75; }
          .about-point { font-size:0.9rem; gap:10px; }
        ...
        @media(max-width:420px){
          ...
          .about-badge { top:10px; left:8px; padding:10px 12px; }
          .about-badge-n { font-size:1.45rem; }
          .about-badge-l { font-size:0.58rem; letter-spacing:0.06em; }
          .about-corner { width:72px; height:72px; right:-5px; bottom:-5px; }
          .tab-btn { font-size:0.66rem; padding:9px 11px; }
          .tab-text { font-size:0.88rem; line-height:1.65; }
          .about-point { font-size:0.84rem; }
          .point-icon { width:16px; height:16px; margin-top:4px; }
          .about-stats { grid-template-columns:1fr; }
          .stat-cell { padding:0.95rem 0.6rem; }
      ...
      <section className="about-section" id="about">
        ...
        <div className="about-grid">
          ...
          <SectionReveal className="reveal-right" delay="0.1s">
            ...
            <h2 className="stitle">
              Built on Direct Sourcing &amp; Honest Trade
            </h2>
